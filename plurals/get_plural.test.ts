...
import { get_plural } from "./get_plural.ts";
...
Deno.test("get_plural", () => {
  ...
  assertEquals(get_plural("casa"), ["casas"]);
  assertEquals(get_plural("casas"), ["casas"]);
  assertEquals(get_plural("estudiante"), ["estudiantes"]);
  assertEquals(get_plural("estudiantes"), ["estudiantes"]);
  assertEquals(get_plural("taxi"), ["taxis"]);
  assertEquals(get_plural("taxis"), ["taxis"]);
  assertEquals(get_plural("plano"), ["planos"]);
  assertEquals(get_plural("planos"), ["planos"]);
  assertEquals(get_plural("tribu"), ["tribus"]);
  assertEquals(get_plural("tribus"), ["tribus"]);
  assertEquals(get_plural("comité"), ["comités"]);
  assertEquals(get_plural("pié"), ["piés"]);
  ...
  assertEquals(get_plural("papá"), ["papás"]);
  assertEquals(get_plural("dominó"), ["dominós"]);
  ...
  assertEquals(get_plural("bisturí"), ["bisturís", "bisturíes"]);
  assertEquals(get_plural("carmesí"), ["carmesís", "carmesíes"]);
  ...
  assertEquals(get_plural("ley"), ["leyes"]);
  assertEquals(get_plural("buey"), ["bueyes"]);
  ...
  assertEquals(get_plural("dandi"), ["dandis"]);
  assertEquals(get_plural("panti"), ["pantis"]);
  assertEquals(get_plural("ferri"), ["ferris"]);

  assertEquals(get_plural("dandy"), ["dandis"]);
  ...
  assertEquals(get_plural("tos"), ["toses"]);
  assertEquals(get_plural("vals"), ["valses"]);
  assertEquals(get_plural("compás"), ["compases"]);
  assertEquals(get_plural("francés"), ["franceses"]);

  assertEquals(get_plural("crisis"), ["crisis"]);
  assertEquals(get_plural("tórax"), ["tórax"]);
  assertEquals(get_plural("fórceps"), ["fórceps"]);
  ...
  assertEquals(get_plural("dócil"), ["dóciles"]);
  assertEquals(get_plural("color"), ["colores"]);
  assertEquals(get_plural("cáliz"), ["cálices"]);
  assertEquals(get_plural("césped"), ["céspedes"]);
  assertEquals(get_plural("reloj"), ["relojes"]);
  assertEquals(get_plural("píxel"), ["píxeles"]);
  assertEquals(get_plural("máster"), ["másteres"]);
  assertEquals(get_plural("interfaz"), ["interfaces"]);
  ...
  assertEquals(get_plural("crac"), ["cracs"]);
  assertEquals(get_plural("zigzag"), ["zigzags"]);
  assertEquals(get_plural("esnob"), ["esnobs"]);
  assertEquals(get_plural("mamut"), ["mamuts"]);
  assertEquals(get_plural("cómic"), ["cómics"]);

  assertEquals(get_plural("iman"), ["imanes"]);
  assertEquals(get_plural("álbum"), ["álbumes"]);
  ...
  assertEquals(get_plural("sándwich"), ["sándwiches"]);
  assertEquals(get_plural("maquech"), ["maqueches"]);
  assertEquals(get_plural("crómlech"), ["crómleches"]);
  ...
  assertEquals(get_plural("gong"), ["gongs"]);
  assertEquals(get_plural("iceberg"), ["icebergs"]);
  assertEquals(get_plural("récord"), ["récords"]);

  // exceptions
  assertEquals(get_plural("compost"), ["compost"]);
  assertEquals(get_plural("karst"), ["karst"]);
  assertEquals(get_plural("test"), ["test"]);
  assertEquals(get_plural("trust"), ["trust"]);
  assertEquals(get_plural("kibutz"), ["kibutz"]);

  assertEquals(get_plural("lord"), ["lores"]);
  assertEquals(get_plural("milord"), ["milores"]);
  ...
  assertEquals(get_plural("ratio"), ["ratios"]);
  assertEquals(get_plural("plus"), ["pluses"]);
  assertEquals(get_plural("lapsus"), ["lapsus"]);
  assertEquals(get_plural("nomenclátor"), ["nomenclátores"]);
  // TODO
  ...
  assertEquals(get_plural("espécimen"), ["especímenes"]);
  assertEquals(get_plural("régimen"), ["regímenes"]);
  assertEquals(get_plural("carácter"), ["caracteres"]);
  ...
  // lucky!
  assertEquals(get_plural("mandingas"), ["mandingas"]);
  //assertEquals(get_plural("masáis"), ["masáis"])
  assertEquals(get_plural("mapuches"), ["mapuches"]);
  assertEquals(get_plural("hutus"), ["hutus"]);
  assertEquals(get_plural("tutsis"), ["tutsis"]);
  assertEquals(get_plural("yanomamis"), ["yanomamis"]);
  assertEquals(get_plural("bantúes"), ["bantúes"]);
  assertEquals(get_plural("guaraníes"), ["guaraníes"]);
  assertEquals(get_plural("iroqueses"), ["iroqueses"]);
  assertEquals(get_plural("patagones"), ["patagones"]);
  ...
  // usage of plural
  assertEquals(get_plural("Córdoba"), ["Córdobas"]);
  ...
  assertEquals(get_plural("pilar"), ["pilares"]);
  assertEquals(get_plural("cármen"), ["cármenes"]);
  assertEquals(get_plural("Raúl"), ["Raúles"]);
  ...
  assertEquals(get_plural("garcía"), ["garcías"]);
  ...
  assertEquals(get_plural("Habsburgo"), ["Habsburgos"]);
  assertEquals(get_plural("Trastámara"), ["Trastámaras"]);
  assertEquals(get_plural("Tudor"), ["Tudores"]);
  assertEquals(get_plural("Borgia"), ["Borgias"]);
  assertEquals(get_plural("borbon"), ["borbones"]);
  ...
  assertEquals(get_plural("Yamaha"), ["Yamahas"]);
